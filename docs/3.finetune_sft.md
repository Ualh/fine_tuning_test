...
## What it does
Runs LoRA fine-tuning in the training container. On success the wrapper can automatically chain follow-up stages (merge, AWQ, eval, serve) in the same run directory.
