...
BASE_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))  # remonte de 2 dossiers : utils -> scripts -> app

config_path = os.path.join(BASE_DIR, 'configs', 'paths.json')
with open(config_path, 'r') as f:
    paths = json.load(f)
    drg_34_dissection_path = paths["drg_34_dissection_path"]
